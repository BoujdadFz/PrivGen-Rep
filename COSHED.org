...
of today. From conception to implementation, privacy concerns should be tackled
...
our needs. C2QL enables the development of privacy-aware applications 
...
The ap- proach essentially consists of two parts: language support for the development
...
Concretely, we suggest a distributed multi-cloud-based architecture
 defined with and by 
